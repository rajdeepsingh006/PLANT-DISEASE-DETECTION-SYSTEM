...
# opacity: 0.8;
# background-image:  repeating-radial-gradient( circle at 0 0, transparent 0, #f3e6f7 40px ), repeating-linear-gradient( #00653f55, #00653f );
# }
# </style>
...
opacity: 0.8;
background-image: radial-gradient(#00653f 2px, #000000 2px);
